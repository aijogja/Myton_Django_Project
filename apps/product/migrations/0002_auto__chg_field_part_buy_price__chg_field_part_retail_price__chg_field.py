...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Part.buy_price'
        db.alter_column(u'product_part', 'buy_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=2))

        # Changing field 'Part.retail_price'
        db.alter_column(u'product_part', 'retail_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=2))

        # Changing field 'Part.surcharge'
        db.alter_column(u'product_part', 'surcharge', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=18, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Part.buy_price'
        db.alter_column(u'product_part', 'buy_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Part.retail_price'
        db.alter_column(u'product_part', 'retail_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Part.surcharge'
        db.alter_column(u'product_part', 'surcharge', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
