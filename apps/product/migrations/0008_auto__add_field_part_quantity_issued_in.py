...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Part.quantity_issued_in'
        db.add_column(u'product_part', 'quantity_issued_in',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Part.quantity_issued_in'
        db.delete_column(u'product_part', 'quantity_issued_in')
    ...
    models = {
        ...
        u'product.part': {
            ...
            'quantity_issued_in': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True'}),
