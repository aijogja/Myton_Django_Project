...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Part.retail_price'
        db.add_column(u'product_part', 'retail_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=18, decimal_places=2),
                      keep_default=False)

        # Adding field 'Part.buy_price'
        db.add_column(u'product_part', 'buy_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=18, decimal_places=2),
                      keep_default=False)

        # Adding field 'Part.surcharge'
        db.add_column(u'product_part', 'surcharge',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=18, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Part.retail_price'
        db.delete_column(u'product_part', 'retail_price')

        # Deleting field 'Part.buy_price'
        db.delete_column(u'product_part', 'buy_price')

        # Deleting field 'Part.surcharge'
        db.delete_column(u'product_part', 'surcharge')
    ...
    models = {
        ...
        u'product.part': {
            ...
            'buy_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '18', 'decimal_places': '2'}),
            ...
            'retail_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '18', 'decimal_places': '2'}),
            ...
            'surcharge': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '18', 'decimal_places': '2'}),
