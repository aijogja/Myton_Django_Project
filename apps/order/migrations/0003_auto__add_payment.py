...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'order_payment', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_payment', to=orm['order.Order'])),
            ('payment', self.gf('django.db.models.fields.CharField')(default='PP', max_length=10)),
            ('ref', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
    ...
    models = {
        ...
        u'order.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'order_payment'", 'to': u"orm['order.Order']"}),
            'payment': ('django.db.models.fields.CharField', [], {'default': "'PP'", 'max_length': '10'}),
