...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.vat'
        db.delete_column(u'customer_profile', 'vat')

        # Adding field 'Profile.vat_free'
        db.add_column(u'customer_profile', 'vat_free',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Profile.vat_number'
        db.add_column(u'customer_profile', 'vat_number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.vat'
        db.add_column(u'customer_profile', 'vat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Profile.vat_free'
        db.delete_column(u'customer_profile', 'vat_free')

        # Deleting field 'Profile.vat_number'
        db.delete_column(u'customer_profile', 'vat_number')
    ...
    models = {
        ...
        u'customer.profile': {
            ...
            'discount': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '10', 'null': 'True'}),
            ...
            'special_offers': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'telephone': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'to': u"orm['auth.User']"}),
            'vat_free': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'vat_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'})
        }
    }
