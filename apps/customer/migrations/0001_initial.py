...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'customer_profile', (
            ...
            ('discount', self.gf('django.db.models.fields.CharField')(default='A', max_length=10, null=True)),
            ('vat', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('mailing_list', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('special_offers', self.gf('django.db.models.fields.BooleanField')(default=True)),
