...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.surcharge'
        db.add_column(u'cart_item', 'surcharge',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=18, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.surcharge'
        db.delete_column(u'cart_item', 'surcharge')
    ...
    models = {
        ...
        u'cart.item': {
            ...
            'surcharge': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '18', 'decimal_places': '2'}),
